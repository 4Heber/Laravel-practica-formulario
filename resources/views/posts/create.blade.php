<x-app-layout>
    ...
    <div class="p-4">
        <h2 class="text-light text-center fs-1">Nuevo post</h2>
    </div>
        ...
        <form action="{{ route('posts.store') }}" method="post" class="form-floating">
            ...
            <div class="d-flex">
                ...
                <div class="mb-4 form-check">
                    <input type="checkbox" class="form-check-input" name="comentable">
            ...
            <div class="d-flex justify-content-between">
                ...
                <div class="form-floating w-25">
                    <select class="form-select rounded-2" id="floatingSelect" name="acceso" aria-label="FloatingSelect" value="{{ old('acceso') }}">
                ...
                {{--Submit button--}}
                <input class="btn btn-primary w-25" type="submit" value="Publicar">
            </div>
